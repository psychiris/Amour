...
ntr-experimental-hardsuit-desc = НаноТрейзен тестирует экспериментальный экокостюм, собранный из блюспейс-проводящих пластин, созданный путём обратной инженерии скафандра Дредноут от Cybersun’s, с проведением реальных испытаний под вашим наблюдением.
